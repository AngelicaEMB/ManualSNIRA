...
El catálogo de nombres se tomó del Atlas de los pueblos indígenas de México del [INALI](http://atlas.inpi.gob.mx/pueblos-indigenas/){:target="_blank"}. Si no está el nombre en la lista, por favor seleccione la opción ‘Otro’.
...
### Comentarios respecto a las personas involucradas
