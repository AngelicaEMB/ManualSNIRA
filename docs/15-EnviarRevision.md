...
**La información de su proyecto estará disponible para la consulta del público en general cuando los datos hayan sido revisados por el equipo de trabajo de la Conabio y haya sido registrada en la base de datos del SNIRA, por lo que el estatus del proyecto se mostrará como ‘REGISTRADO’.**
